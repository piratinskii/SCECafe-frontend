    ...
    return (
        <ChakraProvider>
            <VStack marginTop={50}>
                ...
                <div>
                    <Formik initialValues={{ firstname: '', lastname: '', birthDay: '', email: ''}} validationSchema={validationSchema} enableReinitialize={true}
                            onSubmit={(values, actions) => {
                                ...
                                },1000)} else {toast({title: 'Password and "Retype password" doesnt match', status: "error", isClosable: true,})
                                    actions.setSubmitting(false)}}}>
                        {(props) => (
                            <Form>
                                ...
                                <Field name='phoneNumber' marginBottom={10}>
                                    {({ field, form }) => (
                                        <FormControl isInvalid={form.errors.phoneNumber && form.touched.phoneNumber}>
                                            ...
                                            <Input as={InputMask}  {...field} mask="999 999 99 99" maskChar={null} placeholder='Phone number'/>
